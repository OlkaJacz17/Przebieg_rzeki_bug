...
var style_sentinel_vmap_3 = function(feature, resolution){
    ...
    var labelText = ""; 
    var value = feature.get("Sen_vmap");
    ...
    if (value >= -87.919962 && value <= -64.563030) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -64.563030 && value <= -41.206097) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -41.206097 && value <= -17.849165) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -17.849165 && value <= 5.507768) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 5.507768 && value <= 28.864700) {
            style = [ new ol.style.Style({
